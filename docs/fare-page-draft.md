...
*Draft for the gcrpc.org Victoria Transit fare page, 2026-09-10. Replaces the current fare schedule page and
its "available soon" pass note. Numbers match what is configured in RidePilot (docs/fare-card-design.md,
section 17). Effective date and the card pickup location are placeholders for the transit team.*
