...
Rails.application.config.middleware.insert_before 0, Rack::Cors do
  allow do
    ...
    resource "/api/*",
      ...
      credentials: false
    # The over-the-air update check reads the release file from the WebView
    # (ops/rideavl-ota-updates.md); the APK itself is fetched natively.
    resource "/rideavl-*.json",
      headers: :any,
