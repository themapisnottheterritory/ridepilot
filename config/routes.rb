Rails.application.routes.draw do
  ...
  scope "(:locale)", locale: TranslationEngine.available_locales do
    ...
    namespace 'reports' do
      ...
      "export_trips_in_range", "fare_card_activity", "fixed_route_compliance", "fixed_route_ridership", "inactive_driver_status_report", "ineligible_customer_status_report", "manifest", 
